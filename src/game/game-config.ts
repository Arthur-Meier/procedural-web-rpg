import type { FriendlyNpc, QuestSign, QuestTemplate, StructureBounds } from "./app-types.js";
...
export const SPAWN_HOUSE: StructureBounds = Object.freeze({
  x: 4.8,
  y: -2.1,
  width: 4.8,
  height: 3.4
...
export const SPAWN_HOUSE_FOOTPRINT: StructureBounds = Object.freeze({
  x: SPAWN_HOUSE.x,
...
export const SPAWN_HOUSE_COLLIDER: StructureBounds = SPAWN_HOUSE_FOOTPRINT;

export const GUIDE_NPC: FriendlyNpc = Object.freeze({
...
export const QUEST_SIGN: QuestSign = Object.freeze({
...
export const QUEST_BOARD_TEMPLATE: readonly QuestTemplate[] = Object.freeze([
  {
    id: "huntScout",
