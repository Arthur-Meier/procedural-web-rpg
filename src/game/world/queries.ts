...
import type { Bounds, BreakableObject, WorldChunk } from "../types.js";

export function getChunkCoordinates(x: number, y: number): { x: number; y: number } {
  return {
...
export function getObjectsNear(
...
export function getDiscoveredBounds(discoveredChunks: Set<string>): Bounds {
