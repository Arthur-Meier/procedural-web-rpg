import { computeMagicDamage, computeMoveSpeed, computePhysicalDamage, xpRequiredForNextLevel } from "../../state-helpers.js";
export function renderStatsPanel(refs, player, onSpendStatPoint) {
