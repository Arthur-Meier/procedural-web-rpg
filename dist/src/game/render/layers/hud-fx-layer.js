...
export class HudFxLayer extends WorldRenderLayerBase {
    ...
    drawScreenEffects() {
        ...
        const sunlight = this.ctx.createRadialGradient(this.canvas.width * this.dayNight.celestialX, this.canvas.height * this.dayNight.celestialY, 0, this.canvas.width * this.dayNight.celestialX, this.canvas.height * this.dayNight.celestialY, this.canvas.width * this.dayNight.celestialRadius);
        ...
        this.ctx.fillRect(0, 0, this.canvas.width, this.canvas.height);
        const vignette = this.ctx.createRadialGradient(this.canvas.width / 2, this.canvas.height / 2, this.canvas.height * 0.2, this.canvas.width / 2, this.canvas.height / 2, this.canvas.width * 0.68);
